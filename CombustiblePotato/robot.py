...
class PotatoBot(wpilib.TimedRobot):
    def robotInit(self) -> None:
        ...
        self.vertical_speed_pct = 0.0
        self.rotation_speed_pct = 0.0
    ...
    def teleopPeriodic(self) -> None:
        ...
        self.vertical_speed_pct = -wpimath.applyDeadband(self.lstick.getY(), DEADBAND)
        self.rotation_speed_pct = wpimath.applyDeadband(self.rstick.getX(), DEADBAND)
        
        self.arm_control.update()
        self.intake_control.update()

        self.drivetrain.update()
        self.drivetrain.drive(self.vertical_speed_pct, self.rotation_speed_pct)